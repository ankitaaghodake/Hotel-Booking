function store() {
  ...
  function footer() {
    let footerTemplate = `   
      ...
      <div id="social">
      <a href="https://www.facebook.com" target="_blank"><img class="social-icons" src="Assets/images/facebook.png" alt="facebook" /></a>
      <a href="https://www.instagram.com" target="_blank"><img class="social-icons" src="Assets/images/instagram.png" alt="instagram" /></a>
      <a href="https://twitter.com" target="_blank" ><img class="social-icons" src="Assets/images/twitter.png" alt="twitter" /></a>
    </div>
      <br />
